module.exports = {
  ADDRESS : process.env.HEROKU ? 'https://matchanalyzer.herokuapp.com/' : process.env.DOCKER ? 'http://127.0.0.1:9009/' : 'http://localhost:9000/',
  API_ADDRESS : process.env.HEROKU ? 'https://matchanalyzer.herokuapp.com/api/' : process.env.DOCKER ? 'http://127.0.0.1:9009/api' : 'http://localhost:9000/api/',
